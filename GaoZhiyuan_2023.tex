...
The tech stack includes Next.js, Prisma/MySQL, GPT-3, Stable-Diffusion, Docker and AWS Devops.\\
		...
		\resitem{
3. Data platform to calculate interaction intensity of communication tools
Construct a data platform of company employee interaction intensity.\\
Extract data from communication tools, construct the graph relationships of all employees and load the data into the graph database.\\
		}
	\end{itemize}
	\ressubheading{MISE}{}{Devops Engineer}{Jun. 2022 - Sep. 2022}
	\begin{itemize}
		\resitem{
			- Improve system performances including AWS Lambda, API Gateway and MySQL RDS \\
...
\item
	\ressubheading{Seoul National University}{Korea}{B.S., Computer Science and Engineering}{Sep. 2019 - Quit)}
\end{itemize}

\begin{description}
\item[Skills:]
Python, Java/Typescript, React, AWS, Docker, Git, CI/CD, C/C++, MySQL
\item[Languages:]

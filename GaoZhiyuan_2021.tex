...
\begin{itemize}
\item
        \ressubheading{Alibaba Cloud}{}{Summer of Code Intern}{Jun. 2021 - Sep. 2021}
        \begin{itemize}
                \resitem{Developed QA test cases and Git workflow automation with Typescript, Jest and github workflow.}
        \end{itemize}
\item
...
\item
	...
	\begin{itemize}
		\resitem{Part of the QA team working on openSUSE and SUSE Linux Enterprise, with git and openQA, writing test cases in perl.}
	\end{itemize}
...
\begin{description}
\item[Skills:]
C, Java, python, x86 Assembly, AWS Lambda Functions, Binary Exploitation, Matlab
\item[Languages:]

...
\item
	\ressubheading{Seoul National University}{Korea}{B.S., Computer Science and Engineering}{Sep. 2019 - Aug. 2023(Expected)}
\end{itemize}

\begin{description}
\item[Skills:]
Python, AWS, Docker, Git, CI/CD, C/C++, Java, MySQL
\item[Languages:]
...
\begin{itemize}
\item
	\ressubheading{MISE}{}{Devops Engineer}{Jul. 2022 - Now}
	\begin{itemize}
		\resitem{
			...
			- Solve and follow up with 4 urgent business-impacting security flaws \\
			}
	\end{itemize}
	...
	\end{itemize}
        ...
        \end{itemize}
\item
	\ressubheading{Chinese Academy of Science}{PLCT Lab}{QEMU Developer}{May. 2020 - Nov. 2020}
	\begin{itemize}
